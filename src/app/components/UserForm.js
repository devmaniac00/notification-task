    ...
    return (
        <form className={styles.formContainer} onSubmit={handleSubmit(onSubmit)}>
            <section className={styles.formGroup}>
                ...
                <select id="notificationInterval" {...register("notificationInterval", {required: true})}>
                    <option value="">Select interval</option>
                    <option value="daily">Daily</option>
                    <option value="weekly">Weekly</option>
                    <option value="monthly">Monthly</option>
                </select>
                {errors.notificationInterval && <span className={styles.errorText}>This field is required</span>}
            </section>

            <section className={styles.formGroup}>
                <label htmlFor="searchQuery">Search Query</label>
                <input id="searchQuery" type="text" placeholder="..." {...register("searchQuery", {required: true})} />
            ...
            <section className={styles.formGroup}>
                ...
                <select id="weeklyNotificationDay" {...register("weeklyNotificationDay", {required: true})}>
                ...
                {errors.weeklyNotificationDay && <span className={styles.errorText}>This field is required</span>}
            </section>

            <section className={styles.formGroup}>
                <label htmlFor="emai">Email</label>
                <input id="emai" type="email" placeholder="email@gmail.com" {...register("email", {required: true})} />
            ...
            <section className={styles.formGroup}>
                ...
                <input id="notificationTime" type="time" {...register("notificationTime", {required: true})} />
                {errors.notificationTime && <span className={styles.errorText}>This field is required</span>}
            </section>

            <section className={styles.formGroup}>
                <label htmlFor="relevancyScore">Relevancy Score</label>
                <input id="relevancyScore" type="number" min={0} {...register("relevancyScore", {required: true})} />
                {errors.relevancyScore && <span className={styles.errorText}>This field is required</span>}
            </section>
